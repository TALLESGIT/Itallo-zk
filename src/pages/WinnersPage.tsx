...
const WinnersPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50 pt-2 sm:pt-12 md:pt-16 lg:pt-20">
      <div className="container mx-auto px-4 py-6 sm:py-8">
        {/* Sticky Header */}
        <motion.div
          className="sticky top-0 z-10 bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50/90 backdrop-blur-md text-center mb-8 sm:mb-12 pt-2 pb-4 transition-all duration-300"
        ...
        <div className="max-h-[calc(100vh-180px)] overflow-y-auto pb-8">
